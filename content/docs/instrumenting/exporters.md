...
Some third-party software is directly instrumented using a Prometheus client
library and exposes metrics in the Prometheus format, so no separate exporters
are needed:
